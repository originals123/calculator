...
PowerFunctionElement::PowerFunctionElement() {
    this->setFunctionType(FLAG_POWER);
}
std::string PowerFunctionElement::toString() {
    return StringManupulator::getDoubleArgs(this->arguments[0], this->arguments[1], OP_POWER);
}
...
double PowerFunctionElement::evaluate() {
    ...
    if(arg1_type == FLAG_CONSTANT && arg2_type == FLAG_CONSTANT) {
        ...
        return pow(conObj1->evaluate(), conObj2->evaluate());
    }
    ...
    if(arg1_type == FLAG_CONSTANT && arg2_type == FLAG_VARIABLE) {
        ...
        return pow(conObj->evaluate(), varObj->evaluate());
    }
    ...
    if(arg1_type == FLAG_CONSTANT && arg2_type == FLAG_FUNCTION) {
        ...
        return pow(conObj->evaluate(), FunctionEvaluator::evaluateFunction(funObj));
    }
    ...
    if(arg1_type == FLAG_VARIABLE && arg2_type == FLAG_VARIABLE) {
        ...
        return pow(varObj1->evaluate(), varObj2->evaluate());
    }
    ...
    if(arg1_type == FLAG_VARIABLE && arg2_type == FLAG_CONSTANT) {
        ...
        return pow(varObj->evaluate(), conObj->evaluate());
    }
    ...
    if(arg1_type == FLAG_VARIABLE && arg2_type == FLAG_FUNCTION) {
        VariableElement *varObj = dynamic_cast<VariableElement*>(arg1);
        FunctionElement *funObj = dynamic_cast<FunctionElement*>(arg2);
        return pow(varObj->evaluate(), FunctionEvaluator::evaluateFunction(funObj));
    }
    ...
    if(arg1_type == FLAG_FUNCTION && arg2_type == FLAG_FUNCTION) {
        ...
        return pow(FunctionEvaluator::evaluateFunction(funObj1), FunctionEvaluator::evaluateFunction(funObj2));
    }
    ...
    if(arg1_type == FLAG_FUNCTION && arg2_type == FLAG_CONSTANT) {
        ...
        ConstantElement *conObj = dynamic_cast<ConstantElement*>(arg2);
        return pow(FunctionEvaluator::evaluateFunction(funObj), conObj->evaluate());
    }
    ...
    if(arg1_type == FLAG_FUNCTION && arg2_type == FLAG_VARIABLE) {
        FunctionElement *funObj = dynamic_cast<FunctionElement*>(arg1);
        VariableElement *varObj = dynamic_cast<VariableElement*>(arg2);
        return pow(FunctionEvaluator::evaluateFunction(funObj), varObj->evaluate());
    }
}

...
MinusFucntionElement::MinusFucntionElement()
{
    this->setFunctionType(FLAG_MINUS);

}

string MinusFucntionElement::toString()
{
    return StringManupulator::getDoubleArgs(this->arguments[0], this->arguments[1], OP_MINUS);
}

double MinusFucntionElement::evaluate() {

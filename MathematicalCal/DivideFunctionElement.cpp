...
{
    this->setFunctionType(FLAG_DIVIDE);

}

string DivideFunctionElement::toString()
{
    return StringManupulator::getDoubleArgs(this->arguments[0], this->arguments[1], OP_DIVIDE);
}
